        ...
        case "razorpay":
          {
            ...
            if (responseRazorpay.data.success) {
              ...
              toast.error("Error Occured in Razorpay");
            }
          }
          break;
        default:
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row ">
            ...
            >
              ...
              ></p>
              <img src={assets.stripe_logo2} className="h-5 w-14 mx-4" alt="" />
            </div>
            <div
            ...
            >
              ...
              ></p>
              <img
                src={assets.razorpay_logo2}
                className="h-3.5 w-15 mx-4"
                alt=""
              />
            </div>
            <div
            ...
            >
              ...
              ></p>
              <p className="text-gray-900 font-medium  mx-4">
                CASH ON DELIVERY
              </p>
            </div>
          </div>
